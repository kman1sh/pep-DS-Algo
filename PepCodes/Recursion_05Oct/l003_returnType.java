...
public class l003_returnType {
    ...
    public static void main(String[] args) {
        ...
        // ArrayList<String> a = mazePath_diag_multi(0, 0, 5, 5);
        ...
        // System.out.println(floodFill_eightCalls(0,0,2,2,new boolean[3][3]).size());

        // System.out.println(knightPath(0,0,4,4,new boolean[5][5],"(0, 0), "));
        ...
        // System.out.println(permuatation("abcd").size());

        System.out.println(encoding("001"));
